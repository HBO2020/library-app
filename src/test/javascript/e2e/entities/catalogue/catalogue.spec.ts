...
describe('Catalogue e2e test', () => {
  ...
  it('should load Catalogues', async () => {
    ...
    expect(await catalogueComponentsPage.getTitle()).to.eq('libraryApp.catalogue.home.title');
  ...
  it('should load create Catalogue page', async () => {
    ...
    expect(await catalogueUpdatePage.getPageTitle()).to.eq('libraryApp.catalogue.home.createOrEditLabel');
  ...
  it('should delete last Catalogue', async () => {
    ...
    expect(await catalogueDeleteDialog.getDialogTitle()).to.eq('libraryApp.catalogue.delete.question');
