...
describe('Member e2e test', () => {
  ...
  it('should load Members', async () => {
    ...
    expect(await memberComponentsPage.getTitle()).to.eq('libraryApp.member.home.title');
  ...
  it('should load create Member page', async () => {
    ...
    expect(await memberUpdatePage.getPageTitle()).to.eq('libraryApp.member.home.createOrEditLabel');
  ...
  it('should delete last Member', async () => {
    ...
    expect(await memberDeleteDialog.getDialogTitle()).to.eq('libraryApp.member.delete.question');
