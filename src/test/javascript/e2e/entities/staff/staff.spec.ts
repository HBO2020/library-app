...
describe('Staff e2e test', () => {
  ...
  it('should load Staff', async () => {
    ...
    expect(await staffComponentsPage.getTitle()).to.eq('libraryApp.staff.home.title');
  ...
  it('should load create Staff page', async () => {
    ...
    expect(await staffUpdatePage.getPageTitle()).to.eq('libraryApp.staff.home.createOrEditLabel');
  ...
  it('should delete last Staff', async () => {
    ...
    expect(await staffDeleteDialog.getDialogTitle()).to.eq('libraryApp.staff.delete.question');
