...
describe('Image e2e test', () => {
  ...
  it('should load Images', async () => {
    ...
    expect(await imageComponentsPage.getTitle()).to.eq('libraryApp.image.home.title');
  ...
  it('should load create Image page', async () => {
    ...
    expect(await imageUpdatePage.getPageTitle()).to.eq('libraryApp.image.home.createOrEditLabel');
  ...
  it('should delete last Image', async () => {
    ...
    expect(await imageDeleteDialog.getDialogTitle()).to.eq('libraryApp.image.delete.question');
